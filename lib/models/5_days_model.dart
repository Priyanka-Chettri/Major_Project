...
WeatherModel2 weatherModel2FromJson(String str) => WeatherModel2.fromJson(json.decode(str));
...
enum Description { BROKEN_CLOUDS, OVERCAST_CLOUDS, LIGHT_RAIN, SCATTERED_CLOUDS, FEW_CLOUDS }
